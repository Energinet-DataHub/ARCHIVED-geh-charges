...
|VR.920|Tax indicator must be set to false when creating a subscription|D14|All|N/A|
|VR.921|Tax indicator must be set to false when creating a fee|D14|All|N/A|
