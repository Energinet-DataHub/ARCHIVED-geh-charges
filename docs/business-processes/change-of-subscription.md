...
For further details on how a change of subscription price list is processed within the system, please see the [charge price list process flow](../process-flows/README.md/#Charge-Price-List-Flow).
