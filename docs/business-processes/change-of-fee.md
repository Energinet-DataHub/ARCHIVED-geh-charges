...
For further details on how a change of fee price list is processed within the system, please see the [charge price list process flow](../process-flows/README.md/#charge-price-list-flow).
