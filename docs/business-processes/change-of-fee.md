...
For further details on how a change of fee price list is processed within the system, please see the [change of charge price list process flow](../process-flows/README.md/#Change-of-charge-price-list-flow).
