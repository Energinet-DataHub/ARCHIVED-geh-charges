...
|VR.905|As gaps are not allowed in a Charge's timeline, hence when a charge is stopped, any attempts to update it with an effective date after the stop date, must be rejected.|D14|All|N/A|
