...
module "azfun_link_receiver" {
  ...
  app_settings                              = {
    ...
    CHARGE_LINK_ACCEPTED_SENDER_CONNECTION_STRING = trimsuffix(module.sbtar_link_command_accepted_sender.primary_connection_string, ";EntityPath=${module.sbt_link_command_accepted.name}")
  }
  dependencies                              = [
