...
locals {
    MS_CHARGE_DB_CONNECTION_STRING = "Server=${data.azurerm_key_vault_secret.mssql_data_url.value}; Authentication=Active Directory Managed Identity; Database=${module.mssqldb_charges.name}"
