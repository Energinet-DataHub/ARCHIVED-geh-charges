...
locals {
    ...
    INTEGRATION_EVENTS_LISTENER_CONNECTION_STRING       = "SHARED-RESOURCES--SB-INTEGRATIONEVENTS-SEND-CONNECTION-STRING"
    INTEGRATION_EVENTS_SENDER_CONNECTION_STRING         = "SHARED-RESOURCES--SB-INTEGRATIONEVENTS-LISTEN-CONNECTION-STRING"
