...
locals {
    MS_CHARGE_DB_CONNECTION_STRING = "Server=${data.azurerm_key_vault_secret.mssql_data_url.value},1433;Database=${module.mssqldb_charges.name};Authentication=Active Directory Interactive"
