...
locals {
    MS_CHARGE_DB_CONNECTION_STRING = "Server=tcp:${data.azurerm_key_vault_secret.mssql_data_url.value}; Authentication=Active Directory Default; Database=${module.mssqldb_charges.name}"
