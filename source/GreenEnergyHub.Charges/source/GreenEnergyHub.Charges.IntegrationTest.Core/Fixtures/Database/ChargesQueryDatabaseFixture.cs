...
{
    /// <summary>
    /// A xUnit fixture for sharing a Charges Query database for integration tests.
    ///
    ...
    /// </summary>
    public sealed class ChargesQueryDatabaseFixture : IAsyncLifetime
    {
        public ChargesQueryDatabaseFixture()
        {
            DatabaseManager = new ChargesQueryDatabaseManager();
        }

        public ChargesQueryDatabaseManager DatabaseManager { get; }
