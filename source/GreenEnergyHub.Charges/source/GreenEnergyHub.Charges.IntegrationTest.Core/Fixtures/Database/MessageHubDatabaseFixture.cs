...
namespace GreenEnergyHub.Charges.IntegrationTest.Core.Fixtures.Database
{
    ...
    /// </summary>
    public sealed class MessageHubDatabaseFixture : IAsyncLifetime
    {
        public MessageHubDatabaseFixture()
        {
            DatabaseManager = new MessageHubDatabaseManager();
        }

        public MessageHubDatabaseManager DatabaseManager { get; }
