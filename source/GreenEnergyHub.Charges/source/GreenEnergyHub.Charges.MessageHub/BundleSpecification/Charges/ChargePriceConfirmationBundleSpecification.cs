...
{
    public class ChargePriceConfirmationBundleSpecification : BundleSpecification<AvailableChargeReceiptData, ChargePriceOperationsConfirmedEvent>
    {
        /// <summary>
        ...
        public ChargePriceConfirmationBundleSpecification()
