...
{
    public class ChargeLinksRejectionBundleSpecification : BundleSpecification<AvailableChargeLinkReceiptData, ChargeLinksRejectedEvent>
    {
        /// <summary>
        ...
        public override int GetMessageWeight(AvailableChargeLinkReceiptData data)
        {
            ...
            return (int)Math.Round(
                (data.ReasonCodes.Count * RejectionReasonWeight) + RejectionWeight + data.ReasonCodes.Sum(reason => reason.Text.Length),
