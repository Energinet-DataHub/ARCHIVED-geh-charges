...
{
    public class TaxIndicatorMustNotChangeInUpdateRule : IValidationRule
    {
        ...
        public ValidationRuleIdentifier ValidationRuleIdentifier => ValidationRuleIdentifier.ChangingTaxTariffsIsNotAllowed;
