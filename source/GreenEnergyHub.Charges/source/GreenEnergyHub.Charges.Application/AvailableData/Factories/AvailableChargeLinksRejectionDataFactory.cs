...
namespace GreenEnergyHub.Charges.Application.AvailableData.Factories
{
    public class AvailableChargeLinksRejectionDataFactory
        : AvailableDataFactoryBase<Domain.AvailableData.AvailableChargeLinksReceiptData.AvailableChargeLinksReceiptData, ChargeLinksRejectedEvent>
    {
        ...
        public override async Task<IReadOnlyList<Domain.AvailableData.AvailableChargeLinksReceiptData.AvailableChargeLinksReceiptData>> CreateAsync(
            ChargeLinksRejectedEvent input)
        {
            ...
            if (AvailableDataFactoryHelper.ShouldSkipAvailableData(input.ChargeLinksCommand))
                return new List<Domain.AvailableData.AvailableChargeLinksReceiptData.AvailableChargeLinksReceiptData>();
            ...
            return input.ChargeLinksCommand.Operations.Select(chargeLinkDto =>
                new Domain.AvailableData.AvailableChargeLinksReceiptData.AvailableChargeLinksReceiptData(
