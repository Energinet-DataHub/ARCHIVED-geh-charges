...
namespace GreenEnergyHub.Charges.Application.AvailableData.Factories
{
    public class AvailableChargeRejectionDataFactory :
        AvailableDataFactoryBase<Domain.AvailableData.AvailableChargeReceiptData.AvailableChargeReceiptData, ChargeCommandRejectedEvent>
    {
        ...
        public override async Task<IReadOnlyList<Domain.AvailableData.AvailableChargeReceiptData.AvailableChargeReceiptData>> CreateAsync(ChargeCommandRejectedEvent input)
        {
            ...
            return input.Command.Operations.Select(chargeOperationDto => new Domain.AvailableData.AvailableChargeReceiptData.AvailableChargeReceiptData(
