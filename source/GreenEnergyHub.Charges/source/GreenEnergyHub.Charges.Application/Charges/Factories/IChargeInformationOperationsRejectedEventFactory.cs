...
{
    /// <summary>
    /// Factory for creating <see cref="ChargeInformationOperationsRejectedEvent"/>
    /// </summary>
    public interface IChargeInformationOperationsRejectedEventFactory
    {
        /// <summary>
        /// Factory method for creating <see cref="ChargeInformationOperationsRejectedEvent"/> based on rejected operations and
        ...
        /// <returns><see cref="ChargeInformationOperationsRejectedEvent"/></returns>
        ChargeInformationOperationsRejectedEvent Create(
