...
namespace GreenEnergyHub.Charges.MessageHub.AvailableData.Models.AvailableChargeLinksData
{
        ...
        : AvailableDataFactoryBase<AvailableChargeLinksData, ChargeLinksAcceptedEvent>
    {
        ...
        {
            var result = new List<MessageHub.AvailableData.Models.AvailableChargeLinksData.AvailableChargeLinksData>();
        ...
        private async Task CreateForOperationsAsync(
            ...
            ICollection<MessageHub.AvailableData.Models.AvailableChargeLinksData.AvailableChargeLinksData> result)
        {
            ...
            result.Add(new MessageHub.AvailableData.Models.AvailableChargeLinksData.AvailableChargeLinksData(
