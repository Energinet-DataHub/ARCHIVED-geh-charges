    ...
    public class ChargeCommandBundleHandlerTests
    {
            ...
            ChargeCommandBundleHandler sut)
        {
            ...
            var bundle = chargeInformationCommandBundleBuilder
                .WithDocument(documentDtoBuilder.Build())
                .WithCommand(chargeInformationCommandBuilder.Build())
                .Build();
            ...
            // Assert
            chargeInformationCommandBundleHandler.Verify(
                x => x.HandleAsync(It.IsAny<ChargeInformationCommandBundle>()), Times.Exactly(1));
        }
            ...
            ChargeCommandBundleHandler sut)
        {
            ...
            var bundle = chargePriceCommandBundleBuilder
                .WithDocument(documentDtoBuilder.Build())
                .WithCommand(chargePriceCommandBuilder.Build())
                .Build();
            ...
            // Assert
            chargePriceCommandBundleHandler.Verify(
                x => x.HandleAsync(It.IsAny<ChargePriceCommandBundle>()), Times.Exactly(1));
        }
    }
}
