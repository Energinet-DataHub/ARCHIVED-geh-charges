...
{
    public class ChargeCommandAcceptedEventTestBuilder
    {
        private Instant _publishedTime;
        private ChargeCommand _chargeCommand;

        public ChargeCommandAcceptedEventTestBuilder()
        {
            _publishedTime = SystemClock.Instance.GetCurrentInstant();
            _chargeCommand = new ChargeCommand();
        }

        public ChargeCommandAcceptedEventTestBuilder WithPublishedTime(Instant publishedTime)
        {
            _publishedTime = publishedTime;
            return this;
        }

        public ChargeCommandAcceptedEventTestBuilder WithChargeCommand(ChargeCommand chargeCommand)
        {
