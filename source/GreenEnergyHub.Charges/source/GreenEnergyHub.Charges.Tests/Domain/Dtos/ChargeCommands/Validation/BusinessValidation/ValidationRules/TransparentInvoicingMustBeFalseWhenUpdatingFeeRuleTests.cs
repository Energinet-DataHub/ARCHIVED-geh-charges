...
{
    [UnitTest]
    public class TransparentInvoicingMustBeFalseWhenUpdatingFeeRuleTests
    {
        [Theory]
        ...
        {
            // Arrange
            var sut = new TransparentInvoicingMustBeFalseWhenUpdatingFeeRule(chargeType, transparentInvoicing);
