...
namespace GreenEnergyHub.Charges.Tests.Domain.Dtos.ChargeLinksAcceptedEvent
{
    [UnitTest]
    public class ChargeLinksAcceptedEventFactoryTests
    {
        [Theory]
        [InlineAutoMoqData]
            ...
            [NotNull] ChargeLinksCommand chargeLinksCommand)
        {
            ...
            // Assert
            result.ChargeLinksCommand.ChargeLinksOperations.Should().BeEquivalentTo(chargeLinksCommand.ChargeLinksOperations);
        }
    }
}
