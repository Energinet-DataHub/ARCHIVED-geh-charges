...
namespace GreenEnergyHub.Charges.Tests.MessageHub.Models.AvailableChargeReceiptData
{
    public class CimValidationErrorCodeFactoryTests
    {
        ...
        [InlineAutoMoqData(ValidationRuleIdentifier.MeteringPointDoesNotExistValidation, ReasonCode.E10)]
        [InlineAutoMoqData(ValidationRuleIdentifier.ChargeDoesNotExistValidation, ReasonCode.E0I)]
