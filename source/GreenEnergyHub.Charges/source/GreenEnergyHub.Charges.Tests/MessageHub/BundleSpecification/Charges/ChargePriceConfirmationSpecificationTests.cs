...
{
    [UnitTest]
    public class ChargePriceConfirmationSpecificationTests
    {
        [Theory]
        [InlineAutoMoqData]
        public void GetMessageWeight_WhenCalled_ReturnsConstant(
            AvailableChargeReceiptData availableData,
            ChargePriceConfirmationBundleSpecification sut)
        {
        ...
        {
            // Arrange
            var confirmationMessageWeightInBytes = (long)ChargePriceConfirmationBundleSpecification.MessageWeight * 1000;
