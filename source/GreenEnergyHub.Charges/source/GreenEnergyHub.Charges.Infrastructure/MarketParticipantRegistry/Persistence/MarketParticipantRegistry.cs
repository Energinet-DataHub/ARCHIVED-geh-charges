...
namespace GreenEnergyHub.Charges.Infrastructure.MarketParticipantRegistry.Persistence
{
    ...
    public class MarketParticipantRegistry : DbContext, IMarketParticipantRegistry
    {
        #nullable disable
        public MarketParticipantRegistry(DbContextOptions<MarketParticipantRegistry> options)
            : base(options)
        {
        }
