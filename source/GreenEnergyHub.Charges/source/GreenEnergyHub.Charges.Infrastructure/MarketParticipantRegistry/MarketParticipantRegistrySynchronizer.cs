...
namespace GreenEnergyHub.Charges.Infrastructure.MarketParticipantRegistry
{
    public class MarketParticipantRegistrySynchronizer : IMarketParticipantRegistrySynchronizer
    {
        ...
        public MarketParticipantRegistrySynchronizer(
