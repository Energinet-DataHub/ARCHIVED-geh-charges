...
namespace GreenEnergyHub.Charges.Infrastructure.Contracts.Internal.ChargeCommandRejected
{
    ...
    //             ConvertValidationErrorMessageParameters(validationError.ValidationErrorMessageParameters));
    //     }
    //
    ...
    //                 ValidationErrorMessageParameterType = (ValidationErrorMessageParameterTypeContract)x.ParameterType,
    //             }));
    //
