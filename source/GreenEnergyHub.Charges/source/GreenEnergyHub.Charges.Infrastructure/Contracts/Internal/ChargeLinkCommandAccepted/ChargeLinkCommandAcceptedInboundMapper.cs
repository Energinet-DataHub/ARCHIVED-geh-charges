...
{
    public class ChargeLinkCommandAcceptedInboundMapper
        : ProtobufInboundMapper<GreenEnergyHub.Charges.Infrastructure.Internal.ChargeLinkCommandAccepted.ChargeLinkCommandAccepted>
    {
        ...
        private static DocumentDto ConvertDocument(Infrastructure.Internal.ChargeLinkCommandAccepted.Document document)
        {
        ...
        private static MarketParticipantDto MapMarketParticipant(
            Infrastructure.Internal.ChargeLinkCommandAccepted.MarketParticipant marketParticipant)
        {
        ...
        private static ChargeLinkDto ConvertChargeLink(Infrastructure.Internal.ChargeLinkCommandAccepted.ChargeLink link)
        {
