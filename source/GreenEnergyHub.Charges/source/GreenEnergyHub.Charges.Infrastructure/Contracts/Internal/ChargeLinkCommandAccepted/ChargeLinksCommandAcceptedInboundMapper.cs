...
{
    public class ChargeLinksCommandAcceptedInboundMapper
        : ProtobufInboundMapper<GreenEnergyHub.Charges.Infrastructure.Internal.ChargeLinksCommandAccepted.ChargeLinksCommandAccepted>
    {
        protected override IInboundMessage Convert(
            GreenEnergyHub.Charges.Infrastructure.Internal.ChargeLinksCommandAccepted.ChargeLinksCommandAccepted chargeLinksCommandAcceptedContract)
        {
            return new ChargeLinksAcceptedEvent(
                new ChargeLinksCommand(
                    chargeLinksCommandAcceptedContract.ChargeLinksCommand.MeteringPointId,
                    ConvertDocument(chargeLinksCommandAcceptedContract.ChargeLinksCommand.Document),
                    chargeLinksCommandAcceptedContract.ChargeLinksCommand.ChargeLinks.Select(ConvertChargeLink).ToList()),
                chargeLinksCommandAcceptedContract.PublishedTime.ToInstant());
        }

        private static DocumentDto ConvertDocument(Infrastructure.Internal.ChargeLinksCommandAccepted.Document document)
        {
        ...
        private static MarketParticipantDto MapMarketParticipant(
            Infrastructure.Internal.ChargeLinksCommandAccepted.MarketParticipant marketParticipant)
        {
        ...
        private static ChargeLinkDto ConvertChargeLink(Infrastructure.Internal.ChargeLinksCommandAccepted.ChargeLink link)
        {
