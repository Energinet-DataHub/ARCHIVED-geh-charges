...
{
    public sealed class InboundMessageExtractor<TInboundMessage> : MessageExtractor
        where TInboundMessage : IInboundMessage
    {
        public InboundMessageExtractor(SchemaValidatingMessageDeserializer<TInboundMessage> deserializer)
            : base(deserializer)
        {
        }
