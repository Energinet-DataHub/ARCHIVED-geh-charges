...
namespace GreenEnergyHub.Charges.Infrastructure.Persistence.Repositories
{
    public class AvailableChargeReceiptDataRepository : IAvailableDataRepository<AvailableChargeReceiptData>
    {
        ...
        public async Task AddAsync(IEnumerable<AvailableChargeReceiptData> availableChargeReceiptData)
        {
        ...
        {
            await AddAsync(availableChargeReceiptData).ConfigureAwait(false);
