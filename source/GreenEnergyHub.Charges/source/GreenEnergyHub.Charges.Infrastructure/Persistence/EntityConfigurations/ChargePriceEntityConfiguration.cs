...
{
    public class ChargePriceEntityConfiguration : IEntityTypeConfiguration<ChargePrice>
    {
        public void Configure(EntityTypeBuilder<ChargePrice> builder)
        {
            builder.ToTable(nameof(ChargePrice));
