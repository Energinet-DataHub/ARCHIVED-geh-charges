...
namespace GreenEnergyHub.Charges.Infrastructure.Persistence
{
    ...
    public class ChargesQueryDatabaseContext : DbContext, IChargesQueryDatabaseContext
    {
        #nullable disable
        public ChargesQueryDatabaseContext(DbContextOptions<ChargesQueryDatabaseContext> options)
            : base(options)
        {
        }
        ...
        {
            modelBuilder.HasDefaultSchema(DatabaseSchemaNames.QueryModel);
