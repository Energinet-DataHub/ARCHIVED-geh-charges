...
{
    public sealed class ChargeCommandDeserializer : SchemaValidatingMessageDeserializer<ChargeCommand>
    {
        ...
        protected override async Task<ChargeCommand> ConvertAsync(SchemaValidatingReader reader)
        {
