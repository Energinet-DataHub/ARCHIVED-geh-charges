...
{
    public class BundleRequestDispatcher : IBundleRequestDispatcher
    {
        private readonly IChargeBundleSender _chargeBundleSender;
        private readonly IChargeLinkBundleSender _chargeLinkBundleSender;

        public BundleRequestDispatcher(IChargeBundleSender chargeBundleSender, IChargeLinkBundleSender chargeLinkBundleSender)
        {
            _chargeBundleSender = chargeBundleSender;
            _chargeLinkBundleSender = chargeLinkBundleSender;
        }

        public async Task DispatchToSenderAsync(DataBundleRequestDto request)
        {
