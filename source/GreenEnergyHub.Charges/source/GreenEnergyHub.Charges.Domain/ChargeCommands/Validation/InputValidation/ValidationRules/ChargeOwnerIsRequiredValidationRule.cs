...
namespace GreenEnergyHub.Charges.Domain.ChargeCommands.Validation.InputValidation.ValidationRules
{
    public class ChargeOwnerIsRequiredValidationRule : IValidationRule
    {
        ...
        public ValidationRuleIdentifier ValidationRuleIdentifier => ValidationRuleIdentifier.ChargeOwnerIsRequiredValidation;
    }
}
