...
namespace GreenEnergyHub.Charges.Domain.ChargeInformations
{
    public class ChargeInformationFactory : IChargeInformationFactory
    {
        ...
        public async Task<ChargeInformations.ChargeInformation> CreateFromChargeOperationDtoAsync(ChargeOperationDto chargeOperationDto)
        {
            ...
            return new ChargeInformations.ChargeInformation(
                Guid.NewGuid(),
