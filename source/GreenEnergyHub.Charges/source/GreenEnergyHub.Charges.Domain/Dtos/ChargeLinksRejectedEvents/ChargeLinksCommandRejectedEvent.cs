...
namespace GreenEnergyHub.Charges.Domain.Dtos.ChargeLinksRejectedEvents
{
    public class ChargeLinksCommandRejectedEvent : InternalEventBase
    {
        public ChargeLinksCommandRejectedEvent(
