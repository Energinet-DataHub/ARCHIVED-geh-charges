...
namespace GreenEnergyHub.Charges.Domain.Dtos.ChargeCommands
{
    ...
    {
        public ChargeCommand(DocumentDto document, IReadOnlyCollection<IChargeOperation> chargeOperations)
        {
            Document = document;
        ...
        public IReadOnlyCollection<IChargeOperation> ChargeOperations { get; }
    }
}
