...
namespace GreenEnergyHub.Charges.Domain.Dtos.ChargeCommands
{
    ...
    {
        public ChargeCommand(DocumentDto document, IReadOnlyCollection<ChargeOperation> chargeOperations)
        {
            Document = document;
        ...
        public IReadOnlyCollection<ChargeOperation> ChargeOperations { get; }
    }
}
