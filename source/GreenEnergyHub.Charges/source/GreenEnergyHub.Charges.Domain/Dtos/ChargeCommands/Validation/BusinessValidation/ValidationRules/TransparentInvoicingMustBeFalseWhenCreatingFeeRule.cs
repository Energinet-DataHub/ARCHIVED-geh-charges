...
{
    public class TransparentInvoicingMustBeFalseWhenCreatingFeeRule : IValidationRule
    {
        private readonly ChargeType _chargeType;
        private readonly TransparentInvoicing _transParentInvoicing;

        public TransparentInvoicingMustBeFalseWhenCreatingFeeRule(ChargeType chargeType, TransparentInvoicing transParentInvoicing)
        {
        ...
        public ValidationRuleIdentifier ValidationRuleIdentifier =>
            ValidationRuleIdentifier.TransparentInvoicingMustBeFalseWhenCreatingFee;
    }
}
