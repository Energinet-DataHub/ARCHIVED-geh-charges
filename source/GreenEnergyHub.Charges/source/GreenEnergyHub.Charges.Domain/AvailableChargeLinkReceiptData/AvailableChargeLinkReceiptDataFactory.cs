...
{
    public class AvailableChargeLinkReceiptDataFactory : IAvailableChargeLinkReceiptDataFactory
    {
            ...
            Instant requestDateTime)
        {
            return command.ChargeLinks.Select(
                    link => new AvailableChargeLinkReceiptData(
                        command.Document.Sender.Id, // The sender is now the recipient of the receipt
