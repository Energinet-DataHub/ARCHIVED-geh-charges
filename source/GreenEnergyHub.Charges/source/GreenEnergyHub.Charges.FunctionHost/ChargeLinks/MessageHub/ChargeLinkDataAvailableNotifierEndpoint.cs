    ...
    public class ChargeLinkDataAvailableNotifierEndpoint
    {
        ...
        public async Task RunAsync(
            [ServiceBusTrigger(
                ...
                "%" + EnvironmentSettingNames.ChargeLinksAcceptedDataAvailableSubscriptionName + "%",
                Connection = EnvironmentSettingNames.DataHubListenerConnectionString)]
            byte[] message)
        {
            var chargeLinksAcceptedEvent = await _deserializer
                .FromBytesAsync<ChargeLinksAcceptedEvent>(message)
