...
INSERT INTO charges.charge VALUES (@chargeId2, 'TestTariff2', 3, @chargeOwnerId, 0, 2, 1, 'Description...', 'Grid Access Provider test tariff2', 2, '1999-12-31 23:00:00', NULL)
INSERT INTO charges.charge VALUES (@chargeId3, 'TestFee', 2, @chargeOwnerId, 0, 3, 1, 'Description...', 'Grid Access Provider test fee', 2, '1999-12-31 23:00:00', NULL)
INSERT INTO charges.charge VALUES (@chargeId4, 'TestSubscription', 1, @chargeOwnerId, 0, 4, 1, 'Description...', 'Grid Access Provider test subscription', 2, '1999-12-31 23:00:00', NULL)
