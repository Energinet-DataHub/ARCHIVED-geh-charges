...
{
    [IntegrationTest]
    public class ChargePriceMessagePersisterEndpointTests
    {
        ...
        public class RunAsync : FunctionAppTestBase<ChargesFunctionAppFixture>, IAsyncLifetime
        {
            ...
            [Theory]
            [InlineAutoMoqData]
            public async Task RunAsync_WhenChargePriceOperationsAcceptedEvent_ChargeMessageIsPersisted(
                ChargePriceOperationsAcceptedEventBuilder chargePriceOperationsAcceptedEventBuilder)
            {
                // Arrange
                await using var chargesDatabaseReadContext = _databaseManager.CreateDbContext();

                var operationsConfirmedEvent = chargePriceOperationsAcceptedEventBuilder.Build();
