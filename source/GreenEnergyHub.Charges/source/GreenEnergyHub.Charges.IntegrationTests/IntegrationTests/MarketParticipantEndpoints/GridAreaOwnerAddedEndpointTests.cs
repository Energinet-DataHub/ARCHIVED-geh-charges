    ...
    public class GridAreaOwnerAddedEndpointTests
    {
        ...
        public class RunAsync : IClassFixture<ChargesManagedDependenciesTestFixture>
        {
                ...
                RunAsync_WhenValidGridAreaAddedToMarketParticipantEventHandled_GridAreaShouldHaveUpdatedOwner()
            {
                ...
                var sut = new GridAreaOwnerAddedEndpoint(
                    _fixture.GetService<ISharedIntegrationEventParser>(),
                    _fixture.GetService<IGridAreaOwnerAddedCommandHandler>(),
            ...
            private static byte[] CreateMessage()
            {
                var gridAreaAddedToActorIntegrationEvent = new GridAreaAddedToActorIntegrationEvent(
                    ...
                    Guid.NewGuid());
                var parser = new GridAreaAddedToActorIntegrationEventParser();
                return parser.ParseToSharedIntegrationEvent(gridAreaAddedToActorIntegrationEvent);
            }
        }
    }
}
