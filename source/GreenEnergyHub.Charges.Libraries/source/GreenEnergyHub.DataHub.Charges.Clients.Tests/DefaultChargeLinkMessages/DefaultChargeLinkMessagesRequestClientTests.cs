...
using GreenEnergyHub.DataHub.Charges.Libraries.DefaultChargeLinkMessages;
...
namespace GreenEnergyHub.DataHub.Charges.Clients.CreateDefaultChargeLink.Tests.DefaultChargeLinkMessages
{
    [UnitTest]
